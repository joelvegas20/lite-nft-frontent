    ...
    <div className="flex shadow-md drop-shadow-2xl max-h-16 text-white px-10 py-3 w-full">
      <div className="flex items-center w-full justify-between">
        <div className="flex bg-[#4D3B3B] font-bold rounded-full p-1">
          <button
            className={`px-4 py-2 text-xs font-bold rounded-full ${currentProfileSection === "NFTs"
              ? "bg-white text-black"
              : "text-white"
              }`}
          ...
          <button
            className={`px-4 py-2 text-xs font-bold rounded-full ${currentProfileSection === "Collections"
              ? "bg-white text-black"
              : "text-white"
              }`}
        ...
        <a href="/create-nft" className="group flex items-center transition ease-in-out duration-300 font-bold text-sm gap-2 bg-white text-[#363636] px-5 py-2 rounded-full hover:bg-gray-900 hover:text-white">
